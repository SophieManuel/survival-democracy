...
```{r, echo = FALSE, fig.show='hold', out.width="33%",fig.cap = "Estimations paramétriques et non paramétriques du hasard cumulé pour les modèles Log-normal, Gompertz et Weibull. Les courbes en violet et en doré représentent l'estimation non paramétrique de la fonction de survie par Kaplan-Meier. Les courbes enrouge designent à chaque fois la surive estimée des lois correspondantes"}
