...
Nous observons que le modèle de we
...
title <- c("Exponentiel", "Weibull", "Log-logistic", "Log-normal", "Gamma", "Gompertz")
AIC <- c(democracy.exp$AIC, democracy.weib$AIC, democracy.llog$AIC, democracy.lnorm$AIC, democracy.ga$AIC, democracy.gomp$AIC)

data.frame(title,AIC)
```
