...
Et :
\begin{itemize}
  \item $\alpha > 1 \Longrightarrow h$ est monotone croissante.
  \item $\alpha < 1 \Longrightarrow h$ est monotone décroissante
  \item $\alpha = 1 \Longrightarrow h$ est constante (modèle exponentiel).
\end{itemize}
\end{propetie}


\subsubsection{Modèle de Weibull sans covariables}
